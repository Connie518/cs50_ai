...
def shortest_path(source, target):
    ...
    explored = set()  # Start with an empty explored set.
    frontier.add(Node(source, None, None))  # Start with a frontier that contains the initial state.
    
    # Repeat: If the frontier is empty, then no solution.
